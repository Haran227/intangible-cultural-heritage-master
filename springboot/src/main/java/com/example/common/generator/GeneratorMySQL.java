...
public class GeneratorMySQL {
     ...
     * 数据库连接url
     */
    public static final String URL = "jdbc:mysql://localhost/db_culture";
    /**
     * 数据库 用户名
     */
...
//    public static final String SAVE_PATH = System.getProperty("user.dir") + "/src/main/java";
     ...
     * 保存到包下面
     */
    public static final String PACKAGE = "com.example.springboot";
    /**
     * 要生成的表
     */
    public static final String[] TABLES = {"culture"};
